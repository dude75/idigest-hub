...
class InstanceSettings(Base):
    ...
    rate_limit_login_ip: Mapped[int] = mapped_column(Integer, default=60, nullable=False)
    ...
    rate_limit_signup_ip: Mapped[int] = mapped_column(Integer, default=20, nullable=False)
    rate_limit_signup_global: Mapped[int] = mapped_column(Integer, default=100, nullable=False)
    rate_limit_reset_email: Mapped[int] = mapped_column(Integer, default=3, nullable=False)
    rate_limit_reset_ip: Mapped[int] = mapped_column(Integer, default=10, nullable=False)
    rate_limit_reset_global: Mapped[int] = mapped_column(Integer, default=50, nullable=False)
    rate_limit_reset_confirm_ip: Mapped[int] = mapped_column(Integer, default=30, nullable=False)
    rate_limit_reset_confirm_global: Mapped[int] = mapped_column(Integer, default=100, nullable=False)
    rate_limit_setup_ip: Mapped[int] = mapped_column(Integer, default=5, nullable=False)
    ...
    rate_limit_api_ip: Mapped[int] = mapped_column(Integer, default=300, nullable=False)
    ...
    rate_limit_api_tasks_ip: Mapped[int] = mapped_column(Integer, default=60, nullable=False)
    rate_limit_mcp_poll_user: Mapped[int] = mapped_column(Integer, default=90, nullable=False)
    rate_limit_oauth_register_ip: Mapped[int] = mapped_column(Integer, default=10, nullable=False)
    rate_limit_oauth_register_global: Mapped[int] = mapped_column(Integer, default=50, nullable=False)
    rate_limit_oauth_token_ip: Mapped[int] = mapped_column(Integer, default=120, nullable=False)
    rate_limit_oauth_token_global: Mapped[int] = mapped_column(Integer, default=500, nullable=False)
    rate_limit_public_link_ip: Mapped[int] = mapped_column(Integer, default=300, nullable=False)
    rate_limit_public_link_global: Mapped[int] = mapped_column(Integer, default=5000, nullable=False)
    ...
    user_agreement_text_es: Mapped[str | None] = mapped_column(Text)
    user_agreement_version: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    user_agreement_published: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    personal_data_consent_text_en: Mapped[str | None] = mapped_column(Text)
    personal_data_consent_text_ru: Mapped[str | None] = mapped_column(Text)
    personal_data_consent_text_es: Mapped[str | None] = mapped_column(Text)
    personal_data_consent_version: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    personal_data_consent_published: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    privacy_policy_text_en: Mapped[str | None] = mapped_column(Text)
    privacy_policy_text_ru: Mapped[str | None] = mapped_column(Text)
    privacy_policy_text_es: Mapped[str | None] = mapped_column(Text)
    privacy_policy_version: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    privacy_policy_published: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    landing_footer_text_en: Mapped[str | None] = mapped_column(Text)
    landing_footer_text_ru: Mapped[str | None] = mapped_column(Text)
    landing_footer_text_es: Mapped[str | None] = mapped_column(Text)
    landing_footer_published: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
...
class User(Base):
    ...
    personal_data_consent_accepted_version: Mapped[int | None] = mapped_column(Integer)
    privacy_policy_accepted_version: Mapped[int | None] = mapped_column(Integer)
...
class SummaryPublicLink(Base):
    ...
    __table_args__ = (
        ...
        Index("ix_summary_public_links_org", "org_id"),
    )
