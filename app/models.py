...
class Tariff(Base):
    ...
    price_per_generated_text: Mapped[Decimal] = mapped_column(Numeric(12, 6), nullable=False, default=Decimal("0"))
...
class Task(Base):
    ...
    snap_price_per_generated_text: Mapped[Decimal] = mapped_column(Numeric(12, 6), nullable=False)
