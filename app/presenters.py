...
def org_public(
    ...
    *,
    ...
    body["allow_public_links"] = org.allow_public_links
    return body
...
def skill_public(skill: Skill, extra: dict[str, Any] | None = None) -> dict[str, Any]:
    body = {
        ...
        "name": skill.name,
        "body": skill.body,
        "created_at": isoformat_utc(skill.created_at),
        "updated_at": isoformat_utc(skill.updated_at),
    }
    if extra:
        body.update(extra)
    return body
...
def audio_public(audio: Audio, extra: dict[str, Any] | None = None) -> dict[str, Any]:
    body = {
        ...
        "created_at": isoformat_utc(audio.created_at),
    }
    if extra:
        body.update(extra)
    return body
...
def summary_public(
    ...
    *,
    ...
    payload: dict[str, Any] = {
        ...
        "source_audio_id": source_transcript.source_audio_id if source_transcript else None,
        ...
        "created_at": isoformat_utc(summary.created_at),
    }
